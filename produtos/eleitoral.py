...
# CORRIGIDO: sem import quebrado (reduzir definido localmente)
...
DIGITOS_CARGO = {"vereador": 5, "dep_estadual": 5, "dep_federal": 4, "senador": 3}
            ...
            if en == alvo:
                ...
                if n not in tent:
                    ...
                    enc.append({"numero": n, "energia": alvo, "ideal": alvo == 8,
                                "sigla": ss, "digitos_livres": dl, "soma_sigla": sm,
                                "soma_total": st, "nome_energia": ENERGIAS.get(alvo, ""),
                                "explicacao_calculo": (f"Sigla {ss} ({ss[0]}+{ss[1]}={sm}) + "
