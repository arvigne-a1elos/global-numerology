...
APRESENTACAO_TEXTOS = {
    ...
    "id": {
        ...
        "port_linhas": [["Peta Ekspres", "Analisis cepat", "mulai Rp 24.000"],
                       ["Peta Lengkap", "Analisis mendalam", "mulai Rp 55.000"],
                       ["Peta Pasangan", "Kecocokan dua nama", "mulai Rp 79.000"]],
    ...
    "tr": {
        ...
        "port_linhas": [["Ekspres Harita", "Hızlı analiz", "₺51'den başlayan"],
                    ["Tam Harita", "Derin analiz", "₺120'den başlayan"],
    ...
    "vi": {
        ...
        "port_linhas": [["Bản Đồ Nhanh", "Phân tích nhanh", "từ ₫3,8 triệu"],
                    ["Bản Đồ Đầy Đủ", "Phân tích sâu", "từ ₫8,9 triệu"],
                    ["Bản Đồ Cặp Đôi", "Hợp hai tên", "từ ₫12,7 triệu"]],
        "alcance_t": "4. PHẠM VI",
