...
CONTEUDO = {
    ...
    "en": {
        ...
        "pub_linha": "Geo-targeted Advertising",
        "tabela_descontos": "Progressive Discount Table",
        "grafico_anos": ["Year 1", "Year 5", "Year 10", "Year 20", "Year 50"],
        "grafico_titulo": "Conservative Projection (US$ thousand)",
    ...
    "es": {
        ...
        "duns_porque": "¿Por qué es importante el DUNS?",
        "preco_consciente": "Precio Consciente",
        "idioma_col": "Idioma",
        "falantes_col": "Hablantes (M)",
        "linhas_idiomas": [
            ["Inglés", "1.528"], ["Mandarín", "1.184"], ["Español", "558"],
            ["Francés", "396"], ["Árabe", "335"], ["Portugués", "270"],
            ["Ruso", "255"], ["Indonesio", "255"], ["Alemán", "134"],
            ["Japonés", "123"], ["Vietnamita", "97"], ["Turco", "90"],
            ["Italiano", "85"], ["Hebreo", "9"],
        ],
        "total_linha": "TOTAL",
        "fonte_receita": "Fuente de Ingreso",
        ...
        "grafico_anos": ["Año 1", "Año 5", "Año 10", "Año 20", "Año 50"],
        "grafico_titulo": "Proyección Conservadora (€ miles)",
    ...
    "it": {
        ...
        "linhas_idiomas": [
            ["Inglese", "1.528"], ["Mandarino", "1.184"], ["Spagnolo", "558"],
            ["Francese", "396"], ["Arabo", "335"], ["Portoghese", "270"],
            ["Russo", "255"], ["Indonesiano", "255"], ["Tedesco", "134"],
            ["Giapponese", "123"], ["Vietnamita", "97"], ["Turco", "90"],
            ["Italiano", "85"], ["Ebraico", "9"],
        ],
        "total_linha": "TOTALE",
        "fonte_receita": "Fonte di Ricavo",
        "participacao": "Quota",
        ...
        "grafico_anos": ["Anno 1", "Anno 5", "Anno 10", "Anno 20", "Anno 50"],
        "grafico_titulo": "Proiezione Conservativa (€ migliaia)",
        "grafico_titulo_linha": "Crescimento Proiettato (€ migliaia)",
    ...
    "fr": {
        ...
        "duns_porque": "Pourquoi le DUNS est important",
        "preco_consciente": "Prix Conscient",
        "idioma_col": "Langue",
        "falantes_col": "Locuteurs (M)",
        "linhas_idiomas": [
            ["Anglais", "1.528"], ["Mandarin", "1.184"], ["Espagnol", "558"],
            ["Français", "396"], ["Arabe", "335"], ["Portugais", "270"],
            ["Russe", "255"], ["Indonésien", "255"], ["Allemand", "134"],
            ["Japonais", "123"], ["Vietnamien", "97"], ["Turc", "90"],
            ["Italien", "85"], ["Hébreu", "9"],
        ],
        "total_linha": "TOTAL",
        ...
        "grafico_anos": ["Année 1", "Année 5", "Année 10", "Année 20", "Année 50"],
        "grafico_titulo": "Projection Conservatrice (milliers €)",
    ...
    "de": {
        ...
        "ano": "2026",
        "sumario_titulo": "Zusammenfassung",
        "duns_porque": "Warum die DUNS wichtig ist",
        "preco_consciente": "Bewusste Preisgestaltung",
        "idioma_col": "Sprache",
        "falantes_col": "Sprecher (Mio.)",
        "linhas_idiomas": [
            ["Englisch", "1.528"], ["Mandarin", "1.184"], ["Spanisch", "558"],
            ["Französisch", "396"], ["Arabisch", "335"], ["Portugiesisch", "270"],
            ["Russisch", "255"], ["Indonesisch", "255"], ["Deutsch", "134"],
            ["Japanisch", "123"], ["Vietnamesisch", "97"], ["Türkisch", "90"],
            ["Italienisch", "85"], ["Hebräisch", "9"],
        ],
        "total_linha": "GESAMT",
        ...
        "pub_linha": "Geografisch Zielgerichtete Werbung",
        "tabela_descontos": "Tabelle der Progressiven Rabatte",
        "grafico_anos": ["Jahr 1", "Jahr 5", "Jahr 10", "Jahr 20", "Jahr 50"],
        "grafico_titulo": "Konservative Prognose (€ Tausend)",
        "grafico_titulo_linha": "Projiziertes Wachstum (€ Tausend)",
        "fale_conosco": "Kontakt",
    ...
    "ru": {
        ...
        "ano": "2026",
        "sumario_titulo": "Исполнительное резюме",
        "duns_porque": "Почему важен DUNS",
        "preco_consciente": "Осознанное ценообразование",
        "idioma_col": "Язык",
        "falantes_col": "Говорящие (млн)",
        "linhas_idiomas": [
            ["Английский", "1.528"], ["Китайский (мандарин)", "1.184"], ["Испанский", "558"],
            ["Французский", "396"], ["Арабский", "335"], ["Португальский", "270"],
            ["Русский", "255"], ["Индонезийский", "255"], ["Немецкий", "134"],
            ["Японский", "123"], ["Вьетнамский", "97"], ["Турецкий", "90"],
            ["Итальянский", "85"], ["Иврит", "9"],
        ],
        "total_linha": "ИТОГО",
        ...
        "pub_linha": "Геотаргетированная реклама",
        "tabela_descontos": "Таблица прогрессивных скидок",
        "grafico_anos": ["1-й год", "5-й год", "10-й год", "20-й год", "50-й год"],
        "grafico_titulo": "Консервативный прогноз (₽ тыс.)",
    ...
    "ja": {
        ...
        "preco_consciente": "意識的な価格設定",
        "idioma_col": "言語",
        "falantes_col": "話者（百万人）",
        "linhas_idiomas": [
            ["英語", "1.528"], ["中国語（北京語）", "1.184"], ["スペイン語", "558"],
            ["フランス語", "396"], ["アラビア語", "335"], ["ポルトガル語", "270"],
            ["ロシア語", "255"], ["インドネシア語", "255"], ["ドイツ語", "134"],
            ["日本語", "123"], ["ベトナム語", "97"], ["トルコ語", "90"],
            ["イタリア語", "85"], ["ヘブライ語", "9"],
        ],
        "total_linha": "合計",
        "fonte_receita": "収入源",
        ...
        "grafico_anos": ["1年目", "5年目", "10年目", "20年目", "50年目"],
        "grafico_titulo": "保守的予測（千円）",
    ...
    "zh": {
        ...
        "ano": "2026",
        "sumario_titulo": "执行摘要",
        "duns_porque": "DUNS为何重要",
        "preco_consciente": "有意识的定价",
        "idioma_col": "语言",
        "falantes_col": "使用人数（百万）",
        "linhas_idiomas": [
            ["英语", "1.528"], ["中文（普通话）", "1.184"], ["西班牙语", "558"],
            ["法语", "396"], ["阿拉伯语", "335"], ["葡萄牙语", "270"],
            ["俄语", "255"], ["印度尼西亚语", "255"], ["德语", "134"],
            ["日语", "123"], ["越南语", "97"], ["土耳其语", "90"],
            ["意大利语", "85"], ["希伯来语", "9"],
        ],
        "total_linha": "总计",
        "fonte_receita": "收入来源",
        ...
        "b2b_linha": "B2B — 阶梯折扣",
        "pub_linha": "地理定向广告",
        "tabela_descontos": "阶梯折扣表",
        "grafico_anos": ["第1年", "第5年", "第10年", "第20年", "第50年"],
        "grafico_titulo": "保守预测（千元）",
    ...
    "he": {
        ...
        "linhas_idiomas": [
            ["אנגלית", "1.528"], ["מנדרינית", "1.184"], ["ספרדית", "558"],
            ["צרפתית", "396"], ["ערבית", "335"], ["פורטוגזית", "270"],
            ["רוסית", "255"], ["אינדונזית", "255"], ["גרמנית", "134"],
            ["יפנית", "123"], ["וייטנאמית", "97"], ["טורקית", "90"],
            ["איטלקית", "85"], ["עברית", "9"],
        ],
        "total_linha": "סה״כ",
        ...
        "b2b_linha": "B2B — הנחות מדורגות",
        "pub_linha": "פרסום ממוקד מיקום",
        "tabela_descontos": "טבלת הנחות מדורגות",
        "grafico_anos": ["שנה 1", "שנה 5", "שנה 10", "שנה 20", "שנה 50"],
        "grafico_titulo": "תחזית שמרנית (אלפי ₪)",
        "grafico_titulo_linha": "צמיחה צפויה (אלפי ₪)",
    ...
    "ar": {
        ...
        "duns_porque": "لماذا يهم DUNS",
        "preco_consciente": "التسعير الواعي",
        "idioma_col": "اللغة",
        "falantes_col": "المتحدثون (ملايين)",
        "linhas_idiomas": [
            ["الإنجليزية", "1.528"], ["الماندرين", "1.184"], ["الإسبانية", "558"],
            ["الفرنسية", "396"], ["العربية", "335"], ["البرتغالية", "270"],
            ["الروسية", "255"], ["الإندونيسية", "255"], ["الألمانية", "134"],
            ["اليابانية", "123"], ["الفيتنامية", "97"], ["التركية", "90"],
            ["الإيطالية", "85"], ["العبرية", "9"],
        ],
        "total_linha": "الإجمالي",
        "fonte_receita": "مصدر الإيرادات",
        "participacao": "الحصة",
        "b2c_linha": "B2C — 14 لغة",
        "b2b_linha": "B2B — خصومات تصاعدية",
        "pub_linha": "إعلانات مستهدفة جغرافيًا",
        "tabela_descontos": "جدول الخصومات التصاعدية",
        "grafico_anos": ["السنة 1", "السنة 5", "السنة 10", "السنة 20", "السنة 50"],
        "grafico_titulo": "التوقعات المتحفظة (آلاف ر.س)",
        ...
        "sumario_cards": [
            ...
            ("07", "التوقعات والاستثمار", "أفق 50 عامًا · جولة بذرة ر.س 350 ألف"),
        ],
        ...
        "portfolio_tabela": [
            ["المستوى", "المنتجات", "نطاق السعر (ر.س)", "الملف الشخصي"],
            ["الدخول", "خريطة إكسبرس، استشارة سريعة", "ر.س 35", "فضولي، أول تواصل"],
            ["متوسط", "بحث AI، خريطة كاملة، توافق", "ر.س 71", "مستخدم متفاعل"],
            ["متقدم", "علم الأرقام للأعمال، دورات، رسالة", "ر.س 107–143", "محترف، رائد أعمال"],
            ["بريميوم", "تشخيص كامل، علامة بيضاء شخصية", "ر.س 170–377", "دخل مرتفع، استخدام مؤسسي"],
        ...
        "banners_tabela": [
            ["التقسيم", "ثابت (ر.س/شهر)", "مؤقت (ر.س/شهر)", "ملف المعلن"],
            ["دولة", "ر.س 800", "ر.س 500", "شركات محلية صغيرة، تجارة إقليمية"],
            ["قارة", "ر.س 1,800", "ر.س 1,200", "علامات إقليمية، توسع قاري"],
            ["العالم", "ر.س 3,500", "ر.س 2,500", "شركات عالمية، تطبيقات دولية"],
            ["رعاية حصرية", "ر.س 6,000", "ر.س 4,500/حملة", "رعاة رئيسيون، إطلاقات"],
        ],
        ...
        "b2b_planos": [
            ("الخطة الأساسية · 50 رمزًا", "50× خريطة إكسبرس (ر.س 35 لكل منها). مثالية لبرامج عافية الموظفين وإجراءات الإعداد."),
            ("الخطة المتوسطة · 100 رمز", "50× إكسبرس + 50× بحث AI (ر.س 71). مثالية للموارد البشرية واستراتيجيات العلامة التجارية لصاحب العمل."),
            ("الخطة المميزة · 200 رمز", "100× إكسبرس + 100× خريطة كاملة (ر.س 71). أقصى عمق تحليلي للفرق الكبيرة."),
        ],
        "b2b_tabela": [
        ...
        "projecoes_tabela": [
            ["الأفق", "متحفظ (ر.س)", "متفائل (ر.س)"],
            ["السنة 1", "ر.س 600 ألف", "ر.س 2.4 مليون"],
            ["السنة 3", "ر.س 2.2 مليون", "ر.س 8.4 مليون"],
            ["السنة 5", "ر.س 9.4 مليون", "ر.س 28 مليون"],
            ["السنة 10", "ر.س 56 مليون", "ر.س 150 مليون"],
            ["السنة 20", "ر.س 280 مليون", "ر.س 750 مليون"],
            ["السنة 30", "ر.س 650 مليون", "ر.س 1.68 مليار"],
            ["السنة 40", "ر.س 1.03 مليار", "ر.س 2.8 مليار"],
            ["السنة 50", "ر.س 1.4 مليار", "ر.س 4.68 مليار"],
        ],
        ...
        "invest_dados": [
            ("جولة البذرة", "ر.س 350 ألف"),
            ("التقييم قبل المال", "ر.س 1.4 مليون"),
    ...
    "id": {
        ...
        "preco_consciente": "Penetapan Harga Sadar",
        "idioma_col": "Bahasa",
        "falantes_col": "Penutur (Jt)",
        "linhas_idiomas": [
            ["Inggris", "1.528"], ["Mandarin", "1.184"], ["Spanyol", "558"],
            ["Prancis", "396"], ["Arab", "335"], ["Portugis", "270"],
            ["Rusia", "255"], ["Indonesia", "255"], ["Jerman", "134"],
            ["Jepang", "123"], ["Vietnam", "97"], ["Turki", "90"],
            ["Italia", "85"], ["Ibrani", "9"],
        ],
        "total_linha": "TOTAL",
        ...
        "b2b_linha": "B2B — Diskon Bertingkat",
        "pub_linha": "Iklan Bertarget Lokasi",
        "tabela_descontos": "Tabel Diskon Bertingkat",
        "grafico_anos": ["Tahun 1", "Tahun 5", "Tahun 10", "Tahun 20", "Tahun 50"],
        "grafico_titulo": "Proyeksi Konservatif (Rp ribu)",
    ...
    "vi": {
        ...
        "duns_porque": "Vì sao DUNS quan trọng",
        "preco_consciente": "Định giá có ý thức",
        "idioma_col": "Ngôn ngữ",
        "falantes_col": "Người nói (triệu)",
        "linhas_idiomas": [
            ["Tiếng Anh", "1.528"], ["Tiếng Quan Thoại", "1.184"], ["Tiếng Tây Ban Nha", "558"],
            ["Tiếng Pháp", "396"], ["Tiếng Ả Rập", "335"], ["Tiếng Bồ Đào Nha", "270"],
            ["Tiếng Nga", "255"], ["Tiếng Indonesia", "255"], ["Tiếng Đức", "134"],
            ["Tiếng Nhật", "123"], ["Tiếng Việt", "97"], ["Tiếng Thổ Nhĩ Kỳ", "90"],
            ["Tiếng Ý", "85"], ["Tiếng Do Thái", "9"],
        ],
        "total_linha": "TỔNG CỘNG",
        ...
        "grafico_anos": ["Năm 1", "Năm 5", "Năm 10", "Năm 20", "Năm 50"],
        "grafico_titulo": "Dự báo thận trọng (nghìn ₫)",
        "grafico_titulo_linha": "Tăng trưởng dự kiến (nghìn ₫)",
        "fale_conosco": "Liên hệ",
        ...
        "portfolio_tabela": [
            ...
            ["Cơ bản", "Bản Đồ Nhanh, Tư Vấn Nhanh", "₫ 38.000", "Tò mò, lần đầu tiếp cận"],
            ["Trung cấp", "Tìm Kiếm AI, Bản Đồ Đầy Đủ, Tương Hợp", "₫ 88.000", "Người dùng gắn kết"],
            ["Nâng cao", "Thần Số Học Doanh Nghiệp, Chu Kỳ, Sứ Mệnh", "₫ 125.000 – 175.000", "Chuyên gia, doanh nhân"],
            ["Cao cấp", "Chẩn Đoán Đầy Đủ, Bản Đồ Cá Nhân", "₫ 225.000 – 500.000", "Thu nhập cao, dùng cho doanh nghiệp"],
        ...
        "banners_tabela": [
            ["Phân khúc", "Cố định (₫/tháng)", "Tạm thời (₫/tháng)", "Hồ sơ nhà quảng cáo"],
            ["Quốc gia", "₫ 2.500.000", "₫ 1.600.000", "SME địa phương, thương mại khu vực"],
            ["Châu lục", "₫ 5.700.000", "₫ 3.800.000", "Thương hiệu khu vực, mở rộng châu lục"],
            ["Toàn cầu", "₫ 11.000.000", "₫ 7.800.000", "Công ty toàn cầu, ứng dụng quốc tế"],
            ["Tài trợ độc quyền", "₫ 18.700.000", "₫ 14.100.000/chiến dịch", "Nhà tài trợ chính, ra mắt sản phẩm"],
        ],
        ...
        "b2b_planos": [
            ("Gói Cơ Bản · 50 Mã", "50× Bản Đồ Nhanh (₫ 38.000 mỗi mã). Lý tưởng cho chương trình phúc lợi nhân viên và hoạt động hội nhập."),
            ("Gói Trung Cấp · 100 Mã", "50× Bản Đồ Nhanh + 50× Tìm Kiếm AI (₫ 88.000). Hoàn hảo cho nhân sự và chiến lược thương hiệu tuyển dụng."),
            ("Gói Cao Cấp · 200 Mã", "100× Bản Đồ Nhanh + 100× Bản Đồ Đầy Đủ (₫ 88.000). Độ sâu phân tích tối đa cho đội nhóm lớn."),
        ],
        "b2b_tabela": [
            ["Từ", "Giảm giá", "Hồ sơ", "Sử dụng đề xuất"],
            ["10 mã", "10%", "Đội nhóm nhỏ", "Hoạt động phúc lợi một lần"],
            ["100 mã", "30%", "Doanh nghiệp vừa và nhỏ", "Chương trình phúc lợi hàng quý"],
            ["500 mã", "50%", "Doanh nghiệp trung bình", "Quà tặng thường niên cho nhân viên"],
        ...
        "projecoes_tabela": [
            ["Chu kỳ", "Thận trọng (₫)", "Lạc quan (₫)"],
            ["Năm 1", "₫ 103 triệu", "₫ 405 triệu"],
            ["Năm 3", "₫ 374 triệu", "₫ 1,5 tỷ"],
            ["Năm 5", "₫ 1,6 tỷ", "₫ 4,7 tỷ"],
            ["Năm 10", "₫ 9,4 tỷ", "₫ 25 tỷ"],
            ["Năm 20", "₫ 46,8 tỷ", "₫ 124,6 tỷ"],
            ["Năm 30", "₫ 109,1 tỷ", "₫ 280,4 tỷ"],
            ["Năm 40", "₫ 171,4 tỷ", "₫ 467,3 tỷ"],
            ["Năm 50", "₫ 233,7 tỷ", "₫ 778,8 tỷ"],
        ],
        ...
        "invest_dados": [
            ("Vòng hạt giống", "₫ 11 tỷ"),
            ("Định giá trước đầu tư", "₫ 43,7 tỷ"),
            ("Cổ phần chào bán", "Tối đa 20%"),
        ],
        "invest_contato": [
