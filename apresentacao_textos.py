...
CONTEUDO = {
    ...
    "en": {
        ...
        "sumario_cards": [
            ...
            ("07", "Projeksiyonlar ve Yatırım", "50 yıllık ufuk · Tohum Turu ₺ 580 bin"),
        ],
        ...
        "portfolio_tabela": [
            ["Seviye", "Ürünler", "Fiyat Aralığı (₺)", "Profil"],
            ["Giriş", "Ekspres Harita, Hızlı Danışma", "₺ 58", "Meraklı, ilk temas"],
            ["Orta", "AI Araştırma, Tam Harita, Uyumluluk", "₺ 123", "Etkileşimli kullanıcı"],
            ["İleri", "İş Numerolojisi, Döngüler, Misyon", "₺ 188–254", "Profesyonel, girişimci"],
            ["Premium", "Tam Teşhis, Kişisel White-Label", "₺ 319–710", "Yüksek gelir, kurumsal kullanım"],
        ...
        "banners_tabela": [
            ["Bölümleme", "Sabit (₺/ay)", "Geçici (₺/ay)", "Reklamveren Profili"],
            ["Ülke", "₺ 800", "₺ 500", "Yerel KOBİ'ler, bölgesel ticaret"],
            ["Kıta", "₺ 1.800", "₺ 1.200", "Bölgesel markalar, kıta genişlemesi"],
            ["Dünya", "₺ 3.500", "₺ 2.500", "Küresel şirketler, uluslararası uygulamalar"],
            ["Özel Sponsorluk", "₺ 6.000", "₺ 4.500/kampanya", "Ana sponsorlar, lansmanlar"],
        ],
        ...
        "b2b_planos": [
            ("Temel Plan · 50 Kod", "50× Ekspres Harita (her biri ₺ 58). Çalışan sağlıklı yaşam programları ve işe alım eylemleri için idealdir."),
            ("Orta Plan · 100 Kod", "50× Ekspres + 50× AI Araştırma (₺ 123). İK ve işveren markası stratejileri için mükemmeldir."),
            ("Premium Plan · 200 Kod", "100× Ekspres + 100× Tam Harita (₺ 123). Büyük ekipler için maksimum analitik derinlik."),
        ],
        "b2b_tabela": [
        ...
        "projecoes_tabela": [
            ["Ufuk", "Muhafazakar (₺)", "İyimser (₺)"],
            ["1. Yıl", "₺ 600 bin", "₺ 2,4 milyon"],
            ["3. Yıl", "₺ 2,2 milyon", "₺ 8,4 milyon"],
            ["5. Yıl", "₺ 9,4 milyon", "₺ 28 milyon"],
            ["10. Yıl", "₺ 56 milyon", "₺ 150 milyon"],
            ["20. Yıl", "₺ 280 milyon", "₺ 750 milyon"],
            ["30. Yıl", "₺ 650 milyon", "₺ 1,68 milyar"],
            ["40. Yıl", "₺ 1,03 milyar", "₺ 2,8 milyar"],
            ["50. Yıl", "₺ 1,4 milyar", "₺ 4,68 milyar"],
        ],
        ...
        "invest_dados": [
            ("Tohum Turu", "₺ 580 bin"),
            ("Para Öncesi Değerleme", "₺ 2,3 milyon"),
        ...
        "portfolio_tabela": [
            ...
            ["Cơ bản", "Bản đồ Express, Tư vấn nhanh", "₫ 25.000", "Tò mò, tiếp xúc đầu tiên"],
            ["Trung cấp", "Nghiên cứu AI, Bản đồ đầy đủ, Tương thích", "₫ 53.000", "Người dùng gắn kết"],
            ["Nâng cao", "Thần số kinh doanh, Chu kỳ, Sứ mệnh", "₫ 81.000–109.000", "Chuyên gia, doanh nhân"],
            ["Cao cấp", "Chẩn đoán đầy đủ, White-Label cá nhân", "₫ 137.000–305.000", "Thu nhập cao, sử dụng doanh nghiệp"],
            ["B2B / Doanh nghiệp", "Gói doanh nghiệp, giấy phép, quà tặng", "Theo yêu cầu", "Doanh nghiệp và HR"],
        ],
        ...
        "banners_tabela": [
            ...
            ["Quốc gia", "₫ 8.000.000", "₫ 5.000.000", "SME địa phương, thương mại khu vực"],
            ["Châu lục", "₫ 18.000.000", "₫ 12.000.000", "Thương hiệu khu vực, mở rộng châu lục"],
            ["Toàn cầu", "₫ 35.000.000", "₫ 25.000.000", "Công ty toàn cầu, ứng dụng quốc tế"],
            ["Tài trợ độc quyền", "₫ 60.000.000", "₫ 45.000.000/chiến dịch", "Nhà tài trợ chính, ra mắt"],
        ],
        ...
        "b2b_planos": [
            ("Gói Cơ bản · 50 mã", "50× Bản đồ Express (₫ 25.000 mỗi bản). Lý tưởng cho chương trình sức khỏe nhân viên và hoạt động onboarding."),
            ("Gói Trung cấp · 100 mã", "50× Express + 50× Nghiên cứu AI (₫ 53.000). Hoàn hảo cho HR và chiến lược xây dựng thương hiệu nhà tuyển dụng."),
            ("Gói Cao cấp · 200 mã", "100× Express + 100× Bản đồ đầy đủ (₫ 53.000). Độ sâu phân tích tối đa cho đội ngũ lớn."),
        ],
        "b2b_tabela": [
        ...
        "projecoes_tabela": [
            ["Tầm nhìn", "Thận trọng (₫)", "Lạc quan (₫)"],
            ["Năm 1", "₫ 600 triệu", "₫ 2,4 tỷ"],
            ["Năm 3", "₫ 2,2 tỷ", "₫ 8,4 tỷ"],
            ["Năm 5", "₫ 9,4 tỷ", "₫ 28 tỷ"],
            ["Năm 10", "₫ 56 tỷ", "₫ 150 tỷ"],
            ["Năm 20", "₫ 280 tỷ", "₫ 750 tỷ"],
            ["Năm 30", "₫ 650 tỷ", "₫ 1,68 nghìn tỷ"],
            ["Năm 40", "₫ 1,03 nghìn tỷ", "₫ 2,8 nghìn tỷ"],
            ["Năm 50", "₫ 1,4 nghìn tỷ", "₫ 4,68 nghìn tỷ"],
        ],
        ...
        "invest_dados": [
            ("Vòng Seed", "₫ 1,3 tỷ"),
            ("Định giá trước đầu tư", "₫ 5,2 tỷ"),
            ("Vốn cổ phần chào bán", "Lên đến 20%"),
        ],
        "invest_contato": [
