...
CONTEUDO = {
    ...
    "en": {
        ...
        "b2b_planos": [
            ...
            ("Orta Plan · 100 Kod", "50× Ekspres + 50× AI Araştırma (). İK ve işveren markası stratejileri için mükemmeldir."),
            ("Premium Plan · 200 Kod", "100× Ekspres + 100× Tam Harita (). Büyük ekipler için maksimum analitik derinlik."),
        ],
        "b2b_tabela": [
