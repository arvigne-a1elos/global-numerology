...
// ===== TÍTULOS DOS 8 PRODUTOS (12 idiomas) — dados estáticos =====
// Colocado AQUI no app.js para NÃO depender do translations.js
var PRODUTOS_TRAD = {
  pt:{ nome_canal:"Nome do Canal", nickname:"Nickname Digital", nome_ong:"Nome da ONG", nome_evento:"Nome do Evento", nome_projeto:"Nome do Projeto", nome_equipe:"Nome da Equipe", nome_dominio:"Nome do Domínio", nome_pet:"Nome do Pet" },
  en:{ nome_canal:"Channel Name", nickname:"Digital Nickname", nome_ong:"NGO Name", nome_evento:"Event Name", nome_projeto:"Project Name", nome_equipe:"Team Name", nome_dominio:"Domain Name", nome_pet:"Pet Name" },
  es:{ nome_canal:"Nombre del Canal", nickname:"Apodo Digital", nome_ong:"Nombre de la ONG", nome_evento:"Nombre del Evento", nome_projeto:"Nombre del Proyecto", nome_equipe:"Nombre del Equipo", nome_dominio:"Nombre del Dominio", nome_pet:"Nombre de la Mascota" },
  fr:{ nome_canal:"Nom de la chaîne", nickname:"Surnom numérique", nome_ong:"Nom de l'ONG", nome_evento:"Nom de l'événement", nome_projeto:"Nom du projet", nome_equipe:"Nom de l'équipe", nome_dominio:"Nom de domaine", nome_pet:"Nom de l'animal" },
  it:{ nome_canal:"Nome del canale", nickname:"Soprannome digitale", nome_ong:"Nome dell'ONG", nome_evento:"Nome dell'evento", nome_projeto:"Nome del progetto", nome_equipe:"Nome del team", nome_dominio:"Nome del dominio", nome_pet:"Nome dell'animale" },
  de:{ nome_canal:"Kanalname", nickname:"Digitaler Spitzname", nome_ong:"NGO-Name", nome_evento:"Veranstaltungsname", nome_projeto:"Projektname", nome_equipe:"Teamname", nome_dominio:"Domainname", nome_pet:"Haustiername" },
  ru:{ nome_canal:"Название канала", nickname:"Цифровой никнейм", nome_ong:"Название НПО", nome_evento:"Название события", nome_projeto:"Название проекта", nome_equipe:"Название команды", nome_dominio:"Доменное имя", nome_pet:"Имя питомца" },
  zh:{ nome_canal:"频道名称", nickname:"数字昵称", nome_ong:"非政府组织名称", nome_evento:"活动名称", nome_projeto:"项目名称", nome_equipe:"团队名称", nome_dominio:"域名", nome_pet:"宠物名称" },
  ja:{ nome_canal:"チャンネル名", nickname:"デジタルニックネーム", nome_ong:"NGO名", nome_evento:"イベント名", nome_projeto:"プロジェクト名", nome_equipe:"チーム名", nome_dominio:"ドメイン名", nome_pet:"ペット名" },
  ar:{ nome_canal:"اسم القناة", nickname:"الاسم المستعار الرقمي", nome_ong:"اسم المنظمة", nome_evento:"اسم الفعالية", nome_projeto:"اسم المشروع", nome_equipe:"اسم الفريق", nome_dominio:"اسم النطاق", nome_pet:"اسم الحيوان الأليف" },
  he:{ nome_canal:"שם הערוץ", nickname:"כינוי דיגיטלי", nome_ong:"שם הארגון", nome_evento:"שם האירוע", nome_projeto:"שם הפרויקט", nome_equipe:"שם הצוות", nome_dominio:"שם הדומיין", nome_pet:"שם חיית המחמד" },
  hi:{ nome_canal:"चैनल का नाम", nickname:"डिजिटल उपनाम", nome_ong:"एनजीओ का नाम", nome_evento:"कार्यक्रम का नाम", nome_projeto:"परियोजना का नाम", nome_equipe:"टीम का नाम", nome_dominio:"डोमेन का नाम", nome_pet:"पालतू जानवर का नाम" }
};
// ============================================================
