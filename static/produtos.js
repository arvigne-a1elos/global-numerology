// ===== PRODUTOS_TRAD — títulos dos produtos (12 idiomas) =====
var PRODUTOS_TRAD = {
  pt:{ express:"Mapa Express", completo:"Mapa Completo", urna:"Nome de Urna", eleitoral:"Número Eleitoral",
       nome_pet:"Nome do Pet", nickname:"Nickname Digital", nome_dominio:"Nome do Domínio",
       nome_canal:"Nome do Canal", nome_equipe:"Nome da Equipe", nome_ong:"Nome de ONG",
       nome_projeto:"Nome do Projeto", nome_evento:"Nome do Evento" },
  en:{ express:"Express Map", completo:"Full Map", urna:"Ballot Name", eleitoral:"Electoral Number",
       nome_pet:"Pet Name", nickname:"Digital Nickname", nome_dominio:"Domain Name",
       nome_canal:"Channel Name", nome_equipe:"Team Name", nome_ong:"NGO Name",
       nome_projeto:"Project Name", nome_evento:"Event Name" },
  es:{ express:"Mapa Express", completo:"Mapa Completo", urna:"Nombre de Urna", eleitoral:"Número Electoral",
       nome_pet:"Nombre de la Mascota", nickname:"Apodo Digital", nome_dominio:"Nombre del Dominio",
       nome_canal:"Nombre del Canal", nome_equipe:"Nombre del Equipo", nome_ong:"Nombre de la ONG",
       nome_projeto:"Nombre del Proyecto", nome_evento:"Nombre del Evento" },
  fr:{ express:"Carte Express", completo:"Carte Complète", urna:"Nom d'Urne", eleitoral:"Numéro Électoral",
       nome_pet:"Nom de l'animal", nickname:"Surnom numérique", nome_dominio:"Nom de domaine",
       nome_canal:"Nom de la chaîne", nome_equipe:"Nom de l'équipe", nome_ong:"Nom de l'ONG",
       nome_projeto:"Nom du projet", nome_evento:"Nom de l'événement" },
  it:{ express:"Mappa Express", completo:"Mappa Completa", urna:"Nome d'Urna", eleitoral:"Numero Elettorale",
       nome_pet:"Nome dell'animale", nickname:"Soprannome digitale", nome_dominio:"Nome del dominio",
       nome_canal:"Nome del canale", nome_equipe:"Nome del team", nome_ong:"Nome dell'ONG",
       nome_projeto:"Nome del progetto", nome_evento:"Nome dell'evento" },
  de:{ express:"Express-Karte", completo:"Vollständige Karte", urna:"Urnenname", eleitoral:"Wahlnummer",
       nome_pet:"Haustiername", nickname:"Digitaler Spitzname", nome_dominio:"Domainname",
       nome_canal:"Kanalname", nome_equipe:"Teamname", nome_ong:"NGO-Name",
       nome_projeto:"Projektname", nome_evento:"Veranstaltungsname" },
  ru:{ express:"Экспресс-карта", completo:"Полная карта", urna:"Имя в бюллетене", eleitoral:"Избирательный номер",
       nome_pet:"Имя питомца", nickname:"Цифровой никнейм", nome_dominio:"Доменное имя",
       nome_canal:"Название канала", nome_equipe:"Название команды", nome_ong:"Название НПО",
       nome_projeto:"Название проекта", nome_evento:"Название события" },
  zh:{ express:"快速地图", completo:"完整地图", urna:"选票名称", eleitoral:"选举号码",
       nome_pet:"宠物名称", nickname:"数字昵称", nome_dominio:"域名",
       nome_canal:"频道名称", nome_equipe:"团队名称", nome_ong:"非政府组织名称",
       nome_projeto:"项目名称", nome_evento:"活动名称" },
  ja:{ express:"エクスプレスマップ", completo:"フルマップ", urna:"投票用紙の名前", eleitoral:"選挙番号",
       nome_pet:"ペット名", nickname:"デジタルニックネーム", nome_dominio:"ドメイン名",
       nome_canal:"チャンネル名", nome_equipe:"チーム名", nome_ong:"NGO名",
       nome_projeto:"プロジェクト名", nome_evento:"イベント名" },
  ar:{ express:"خريطة سريعة", completo:"خريطة كاملة", urna:"اسم الاقتراع", eleitoral:"رقم الانتخاب",
       nome_pet:"اسم الحيوان الأليف", nickname:"الاسم المستعار الرقمي", nome_dominio:"اسم النطاق",
       nome_canal:"اسم القناة", nome_equipe:"اسم الفريق", nome_ong:"اسم المنظمة",
       nome_projeto:"اسم المشروع", nome_evento:"اسم الفعالية" },
  he:{ express:"מפה אקספרס", completo:"מפה מלאה", urna:"שם בקלפי", eleitoral:"מספר בחירות",
       nome_pet:"שם חיית המחמד", nickname:"כינוי דיגיטלי", nome_dominio:"שם הדומיין",
       nome_canal:"שם הערוץ", nome_equipe:"שם הצוות", nome_ong:"שם הארגון",
       nome_projeto:"שם הפרויקט", nome_evento:"שם האירוע" },
  hi:{ express:"एक्सप्रेस मैप", completo:"पूर्ण मैप", urna:"मतपत्र नाम", eleitoral:"चुनाव संख्या",
       nome_pet:"पालतू जानवर का नाम", nickname:"डिजिटल उपनाम", nome_dominio:"डोमेन का नाम",
       nome_canal:"चैनल का नाम", nome_equipe:"टीम का नाम", nome_ong:"एनजीओ का नाम",
       nome_projeto:"परियोजना का नाम", nome_evento:"कार्यक्रम का नाम" }
};
